...
public class HudIndicatorOverlay extends GUIElement {
    ...
    private void calcNeighborSectors(Vector3i var1) {
        int var2 = (int)((GameClientState)this.getState()).getSectorSize();
        Vector3i var3 = new Vector3i();
        Vector3f var4 = new Vector3f();
        var3.set(var1);

        for(int var5 = 0; var5 < 6; ++var5) {
            this.neighborSectorsPos[var5].set(var1);
            var3.set(var1);
            Vector3i var6 = Element.DIRECTIONSi[var5];
            var3.add(var6);
            this.neighborSectorsPos[var5].set(var3);
            var4.set((float)(var6.x * var2), (float)(var6.y * var2), (float)(var6.z * var2));
            this.neighborSectorsNames[var5] = StringTools.format(Lng.ORG_SCHEMA_GAME_CLIENT_VIEW_GUI_SHIPHUD_HUDINDICATOROVERLAY_3, new Object[]{var3.toString()});
            this.neighborSectors[var5].origin.set(var4);
        }
    ...
    public void draw() {
        ...
        if ((var1 = ((GameClientState)this.getState()).getCurrentRemoteSector()) == null || !var1.isNoIndicationsClient()) {
            ...
            if ((var15 = ((GameClientState)this.getState()).getController().getTutorialMode()) != null && var15.markers != null) {
                ...
                Vector3i var18;
                if ((var18 = ((GameClientState)this.getState()).getController().getClientGameData().getWaypoint()) != null) {
                    ...
                    this.calcWaypointSecPos(new Vector3i(var18), var4);
                    this.drawFor(var4, StringTools.format(Lng.ORG_SCHEMA_GAME_CLIENT_VIEW_GUI_SHIPHUD_HUDINDICATOROVERLAY_4, new Object[]{var18.toString()}), -300, true, true);
                }
