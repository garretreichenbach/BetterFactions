 ...
 * @author TheDerpGamer
 */
public class FactionMessagePanelOld extends GUIInputPanel {
    ...
    public FactionMessagePanelOld(InputState inputState, GUICallback callback, String title, Faction from, Faction to) {
