...
import videogoose.betterfactions.gui.faction.news.FactionNewsEntry;
...
public class FactionNewsUtils {
    ...
    public static FactionNewsEntry getFactionCreateNews(Faction faction, PlayerState player) {
    ...
    public static FactionNewsEntry getFactionDisbandNews(Faction faction) {
        String factionName = faction.getName();
    ...
    public static FactionNewsEntry getFactionJoinNews(Faction faction, PlayerState player) {
        String factionName = faction.getName();
        String playerName = player.getName();
    ...
    public static FactionNewsEntry getFactionLeaveNews(Faction faction, PlayerState player) {
        String factionName = faction.getName();
        String playerName = player.getName();
    ...
    public static FactionNewsEntry getFederationCreateNews(FederationData federationData) {
        String faction1Name = federationData.getMemberName(0);
        String faction2Name = federationData.getMemberName(1);
    ...
    public static FactionNewsEntry getFederationJoinNews(FederationData federationData, Faction faction) {
    ...
    public static FactionNewsEntry getFederationLeaveNews(FederationData federationData, Faction faction) {
