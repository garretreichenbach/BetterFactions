...
import thederpgamer.betterfactions.manager.cache.CacheManager;
...
public class ClientUpdatePacket extends Packet {
	...
	public ClientUpdatePacket(UpdateManager.UpdateType updateType, Object... args) {
	...
	public void processPacketOnServer(PlayerState playerState) {
		CacheManager.getInstance().updateCache(updateType, args);
	}
}
